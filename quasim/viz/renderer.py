...
def render_frame(spec: FlowFrameSpec, dpi: int = 100) -> np.ndarray:
    ...
    fig.suptitle(f'QuASIM Flow — Frame {spec.frame_idx} (t={spec.time:.3f})', 
                 fontsize=14, fontweight='bold')
    
    # Control value
    axes[0, 0].text(0.5, 0.5, f'{spec.control:.4f}', 
    ...
    # Objective
    axes[0, 1].text(0.5, 0.5, f'{spec.objective:.4f}', 
                    ha='center', va='center', fontsize=32, fontweight='bold',
                    color='darkred')
    ...
    # W2 distance
    axes[0, 2].text(0.5, 0.5, f'{spec.w2:.4f}', 
    ...
    # Fisher-Rao speed
    axes[1, 0].text(0.5, 0.5, f'{spec.fr_speed:.4f}', 
                    ha='center', va='center', fontsize=28, fontweight='bold',
                    color='darkgreen')
    ...
    # Bures distance & QFI
    axes[1, 1].text(0.5, 0.6, f'{spec.bures_dist:.4f}', 
                    ha='center', va='center', fontsize=24, fontweight='bold',
                    color='purple')
    axes[1, 1].text(0.5, 0.3, f'QFI: {spec.qfi:.4f}', 
                    ha='center', va='center', fontsize=18, color='purple')
    ...
    axes[1, 2].text(0.5, 0.6, f'{spec.fidelity:.4f}', 
                    ha='center', va='center', fontsize=24, fontweight='bold',
                    color='darkorange')
    axes[1, 2].text(0.5, 0.3, f'FE: {spec.free_energy:.4f}', 
                    ha='center', va='center', fontsize=18, color='darkorange')
