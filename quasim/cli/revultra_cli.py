...
def analyze(ciphertext: str | None, file: str | None, plot: bool, export: str | None, max_period: int):
    ...
    if export:
        ...
        output = json.dumps(results, indent=2, default=lambda o: o.tolist() if hasattr(o, "tolist") else str(o))
        click.echo(output)
...
@cli.command("demo")
@click.option("--section", type=click.Choice(["kryptos", "simple", "all"]), default="kryptos", help="Demo section to run")
